...
class Db_model extends CI_Model
{
    ...
    public function getTotalInProgress()
    {
        $this->db->select('count(id) as id', FALSE)
            ->where('type_detail =', 'In Progress')->where('type =', 'Repair');
        $q = $this->db->get('sales');
        if ($q->num_rows() > 0) {
            return $q->row();
        }
    ...
    {
        $this->db->select('count(id) as id', FALSE)
            ->where('type_detail =', 'In Progress')->where('type =', 'Repair')->where('payment_status =', 'paid');
        $q = $this->db->get('sales');
        if ($q->num_rows() > 0) {
            return $q->row();
        }
    ...
    {
        $this->db->select('count(id) as id', FALSE)
            ->where('type_detail =', 'In Progress')->where('type =', 'Repair')->where('payment_status =', 'due');
        $q = $this->db->get('sales');
        if ($q->num_rows() > 0) {
            return $q->row();
        }
    ...
    public function getTotalWaitingForParts()
    {
        $this->db->select('count(id) as id', FALSE)
            ->where('type_detail =', 'Waiting for Parts');
        $q = $this->db->get('sales');
        if ($q->num_rows() > 0) {
            return $q->row();
        }
    ...
    {
        $this->db->select('count(id) as id', FALSE)
            ->where('type_detail =', 'Waiting for Parts')->where('payment_status =', 'paid');
        $q = $this->db->get('sales');
        if ($q->num_rows() > 0) {
            return $q->row();
        }
    ...
    {
        $this->db->select('count(id) as id', FALSE)
            ->where('type_detail =', 'Waiting for Parts')->where('payment_status =', 'due');
        $q = $this->db->get('sales');
        if ($q->num_rows() > 0) {
            return $q->row();
        }
    ...
    public function getTotalReturnFixable()
    {
        $this->db->select('count(id) as id', FALSE)
            ->where('type_detail =', 'Return/Not Fixable');
        $q = $this->db->get('sales');
        if ($q->num_rows() > 0) {
            return $q->row();
        }
    ...
    {
        $this->db->select('count(id) as id', FALSE)
            ->where('type_detail =', 'Return/Not Fixable')->where('payment_status =', 'paid');
        $q = $this->db->get('sales');
        if ($q->num_rows() > 0) {
            return $q->row();
        }
    ...
    {
        $this->db->select('count(id) as id', FALSE)
            ->where('type_detail =', 'Return/Not Fixable')->where('payment_status =', 'due');
        $q = $this->db->get('sales');
        if ($q->num_rows() > 0) {
            return $q->row();
        }
    ...
    public function getTotalReady()
    {
        $this->db->select('count(id) as id', FALSE)
            ->where('type_detail =', 'Ready');
        $q = $this->db->get('sales');
        if ($q->num_rows() > 0) {
            return $q->row();
        }
    ...
    {
        $this->db->select('count(id) as id', FALSE)
            ->where('type_detail =', 'Ready')->where('payment_status =', 'paid');
        $q = $this->db->get('sales');
        if ($q->num_rows() > 0) {
            return $q->row();
        }
    ...
    {
        $this->db->select('count(id) as id', FALSE)
            ->where('type_detail =', 'Ready')->where('payment_status =', 'due');
        $q = $this->db->get('sales');
        if ($q->num_rows() > 0) {
            return $q->row();
        }
