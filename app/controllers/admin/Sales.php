...
//        $this->sma->checkPermissions(false, true);
    ...
    public function repair_list_ready($warehouse_id = null)
    {
        $this->sma->checkPermissions();
        ...
        $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => '#', 'page' => lang('Repair')));
        $meta = array('page_title' => lang('Repair'), 'bc' => $bc);
        $this->page_construct('sales/repair_list_ready', $meta, $this->data);
    }


    public function getRepairReady($warehouse_id = null)
    {
        $this->sma->checkPermissions('index');
