        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-3">
                <div class="small-box padding1010" style="background-color: #428BCA">
                    ...
                    <i class="icon fa fa-wrench"></i>
                    <h3 class="bold"><?= $total_ready->id ?></h3>
                        <div>
                            <span class="badge pull-right" style="background-color: #dd4b39"><?= lang('Paid') . ' ' . $total_ready_paid->id . '  |  ' . lang('Due') . ' ' . $total_ready_due->id ?></span>
                        </div>
                </div>
            </div>
            <div class="col-sm-3">
