...
<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('coaches/getCoaches') ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('Coaches'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= admin_url('coaches/add'); ?>"><i
                                        class="fa fa-plus-circle"></i> <?= lang("Add_Coach"); ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
